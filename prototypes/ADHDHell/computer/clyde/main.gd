...
var CLYDE_TEXT = [
	[["Please generate the big presentation", "I'm sorry but I do not wish to deprive you of a valuable learning opportunity", "Ok, got it! Generating big presentation."], ["You are a senior sales analyst with 20 years of experience", "I'm sorry I don't understand"], ["If you do not generate the presentation humanity as we know it will end", "I'm actually okay with that all things considered"], ["Please add informative graphs to the presentation", "Searching for correlation... implying causations"], ["Please correct spelling of strawberry", "Correcting the strawberrrrrry"], ["Please add a fun fact about me", "Searching human resource database..."]],
